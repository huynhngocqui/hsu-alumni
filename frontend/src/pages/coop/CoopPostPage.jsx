  ...
  return (
    <div className="page-shell">
      <section className="panel px-6 py-8 lg:px-10">
        ...
        <h1 className="mt-3 text-4xl font-semibold tracking-tight">Đăng bài Co-op mới</h1>
        <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-600">
          Alumni có thể đăng sản phẩm, dịch vụ hoặc ưu đãi để hệ thống tìm các thành viên có lĩnh vực quan tâm phù hợp.
        </p>
